...
let
  modelFiles = {
    ...
    "qwen36-35b-a3b" = pkgs.fetchurl {
      url = "https://huggingface.co/unsloth/Qwen3.6-35B-A3B-MTP-GGUF/resolve/main/Qwen3.6-35B-A3B-UD-Q6_K_XL.gguf";
      hash = "sha256-NfzplM02EEp9wb2KS98Td4FFZkwA/e9nc668kkblAZw=";
    };
