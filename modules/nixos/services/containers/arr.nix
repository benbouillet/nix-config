...
}:
{
  ...
  virtualisation.oci-containers.containers = {
    ...
    "nzbget" = {
      image = "lscr.io/linuxserver/nzbget:26.3.20260918@sha256:3b92679543623c8710fec557de7dd525d55bb5dfc8c59526f054123eaae0f995";
      environment = {
        PUID = toString globals.users.arr.UID;
        PGID = toString globals.groups.containers.GID;
        TZ = "Europe/Paris";
    ...
    "bazarr" = {
      image = "lscr.io/linuxserver/bazarr:1.6.1@sha256:762f802274598da27255b2e5778f262b2b71b355a23e3812d9ee1520f8dbe37c";
      environment = {
        PUID = toString globals.users.arr.UID;
        PGID = toString globals.groups.containers.GID;
        TZ = "Europe/Paris";
