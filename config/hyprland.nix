  ...
  wayland.windowManager.hyprland = {
    ...
    settings =
      ...
      bindd = [
        ...
        "${modifier}SHIFT,V,Screenshot Active Window,exec,hyprshot -m active -z --clipboard-only"
        "${modifier}SHIFT,B,Screenshot Region,exec,hyprshot -m active -z --clipboard-only"
        "${modifier}SHIFT,N,Screenshot Active Window,exec,hyprshot -m active -z --output-folder $HOME/Downloads"
        "${modifier}SHIFT,M,Screenshot Region,exec,hyprshot -m active -z --output-folder $HOME/Downloads"
